//TODO if the modified DB Helper works correctly this class can be removed
//The new version eliminates the copy of code and use helper methods
//package ch.bfh.evoting.voterapp.db;
//
